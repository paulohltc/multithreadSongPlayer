...
public class Playlist {
    ...
    class NextPrevSongThread extends Thread {
        ...
        public NextPrevSongThread(boolean next,boolean randomize) {
            this.next = next;
        ...
        public void run() {
            if (!Playlist.this.playlist.isEmpty()) {
                ...
                if (next) {
                    ...
                    if(this.randomize){
                        newIndex = rand.nextInt(Playlist.this.getPlaylistSize());
                    }else {
...
//
    ...
    public Thread getNextPrevSongThread(boolean next,boolean randomize) {
        return new NextPrevSongThread(next,randomize);
    }
